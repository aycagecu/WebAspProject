...
namespace AuthorizationProject.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<UserDetails> userManager,       //user details ile model bağlamayı burada yapar
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new UserDetails { UserAd = Input.Ad, UserSoyad = Input.Soyad, UserName = Input.Email, Email = Input.Email };
